<template>
  <div class="md:max-w-[1200px] mx-auto ">
    <form @submit.prevent="submit" class="block w-80 mx-auto p-5 pt-7">
      <h1 class="p-4 h3 mb-3 fw-normal text-center font-semibold bg-slate-200 text-2xl">כניסה לרשומים</h1>
