<template>
    <form @submit.prevent="submit" class="md:w-full  block">
      <div>
        ...
        <div class="p-4 max-sm:p-0" >
          <p class=" flex items-center h-auto my-2  flex-wrap border-b-gray-200 border-b-[1px] pb-3">
            <div class="max-sm:w-1/2 flex max-sm:block break-normal">
              <strong>שם פרטי : &nbsp;</strong>
              <div class="max-sm:w-1/8"> {{ babySitter.firstName }}</div>
            </div>
          ...
          <p class="flex items-center h-auto my-2 border-b-gray-200 border-b-[1px] pb-3">
            <div class="max-sm:w-1/2 flex max-sm:block break-normal">
              <strong>מגדר : &nbsp;</strong>
          ...
          <div class="flex items-center my-1 h-auto border-b-gray-200 border-b-[1px] pb-3">
            <div class="h-full">
              <p class="font-semibold">{{ babySitter.firstName }} עובד.ת עם גילאים: </p>
              <div class="inline-block w-full" v-for="age of babySitter.ageGroups">
                <li >{{  age }}</li>
              </div>
            </div>
